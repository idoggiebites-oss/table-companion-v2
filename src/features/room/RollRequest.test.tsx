...
describe("the DM has asked you for a roll", () => {
  it("says what, why, and what to beat", async () => {
    ...
    expect(text(phone)).toContain("Wisdomability check");
    expect(text(phone)).not.toContain("Perception check");
  ...
  it("names the ability alone when the DM asked for a bare one", async () => {
    /* "Wisdom Check" says it; a "Wisdom · ability check" block underneath is
       the app filling a slot rather than telling anybody anything. */
