#!/usr/bin/env node
/* Tier 4. Eleven checks, each making a class of bug unwritable. */
...
import { run as homebrew } from "./checks/homebrew.mjs";

const checks = [css, contrast, inline, size, locators, imports, glyphs, styles, keys, cycles, homebrew];
let bad = 0;
